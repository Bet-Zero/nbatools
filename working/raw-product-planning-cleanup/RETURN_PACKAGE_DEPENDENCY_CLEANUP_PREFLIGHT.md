...
| `docs/planning/raw-product/WEAK_CONTRACT_DECISION_PREFLIGHT.md` | Historical weak-contract context cites result-contract packages. | Replace with durable result-contract docs and inline historical summary. |
| `docs/planning/raw-product/LEADERBOARD_SUPPORTING_COLUMNS_PREFLIGHT.md` | Historical result-contract and weak-contract context cites packages. | Replace with durable result-contract docs, weak-contract preflight, and cleanup summary. |
...
| `docs/planning/raw-product/VISUAL_QA_NOTES.md` | Visual follow-up notes cite older visual fix packages. | Promote findings into the notes or current visual checklist, then remove package paths. |
