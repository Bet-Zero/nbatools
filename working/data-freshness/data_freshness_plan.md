...
- **Contracts first.** Refresh jobs must produce the columns required by [docs/reference/data_contracts.md](../../docs/reference/data_contracts.md). If a pull regresses a required column, that is a freshness bug, not a cosmetic one.
...
All raw data originates from the NBA data source via the existing `pull-*` commands documented in [docs/operations/pipeline_runbook.md](../../docs/operations/pipeline_runbook.md).
...
- `player_game_stats` — [docs/reference/data_contracts.md](../../docs/reference/data_contracts.md#1-player_game_stats)
- `team_game_stats` — [docs/reference/data_contracts.md](../../docs/reference/data_contracts.md#2-team_game_stats)
...
Once `2025-26 Playoffs` data begins to appear, add a parallel refresh for `--season-type "Playoffs"` on the same cadence. Until then, playoff pulls cleanly skip per [docs/operations/pipeline_runbook.md](../../docs/operations/pipeline_runbook.md#4-playoff-handling).
...
Historical coverage today is `1996-97` through `2024-25` for both season types, plus `2025-26 Regular Season`. See [docs/reference/data_catalog.md](../../docs/reference/data_catalog.md#6-coverage-status).
