...
OUTPUT_REFERENCE_ALLOWLIST = {
    ...
    Path("docs/operations/query_validation_map.md"): (
        ...
        "outputs/raw_query_answer_qa/20260606T232744Z/",
        "outputs/raw_query_answer_qa/20260606T232744Z/product_review.md",
        "outputs/raw_query_answer_qa/20260606T233148Z/",
