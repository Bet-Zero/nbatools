...
TEAM_LEADERBOARD_STAT_ALIASES: dict[str, str] = {
    ...
    "fewest points allowed per game": "opponent_pts_per_game",
    "fewest points allowed": "opponent_pts_per_game",
    "least points allowed per game": "opponent_pts_per_game",
    "least points allowed": "opponent_pts_per_game",
    "allow the fewest points per game": "opponent_pts_per_game",
    "allow the fewest points": "opponent_pts_per_game",
    "allow the most points per game": "opponent_pts_per_game",
    "allow the most points": "opponent_pts_per_game",
    "allows the fewest points per game": "opponent_pts_per_game",
    "allows the fewest points": "opponent_pts_per_game",
    "allows the most points per game": "opponent_pts_per_game",
    "allows the most points": "opponent_pts_per_game",
    "allowing the fewest points per game": "opponent_pts_per_game",
    "allowing the fewest points": "opponent_pts_per_game",
    "allowing the most points per game": "opponent_pts_per_game",
    "allowing the most points": "opponent_pts_per_game",
    "allowed the most points per game": "opponent_pts_per_game",
    "allowed the most points": "opponent_pts_per_game",
    "allowed the fewest points per game": "opponent_pts_per_game",
    "allowed the fewest points": "opponent_pts_per_game",
    "gave up the fewest points per game": "opponent_pts_per_game",
    "gave up the fewest points": "opponent_pts_per_game",
    "gave up fewest points per game": "opponent_pts_per_game",
    "gave up fewest points": "opponent_pts_per_game",
    "gave up the most points per game": "opponent_pts_per_game",
    "gave up the most points": "opponent_pts_per_game",
    "gave up most points per game": "opponent_pts_per_game",
    "gave up most points": "opponent_pts_per_game",
    "giving up the fewest points per game": "opponent_pts_per_game",
    "giving up the fewest points": "opponent_pts_per_game",
    "giving up fewest points per game": "opponent_pts_per_game",
    "giving up fewest points": "opponent_pts_per_game",
    "giving up the most points per game": "opponent_pts_per_game",
    "giving up the most points": "opponent_pts_per_game",
    "giving up most points per game": "opponent_pts_per_game",
    "giving up most points": "opponent_pts_per_game",
    "most points allowed per game": "opponent_pts_per_game",
    "most points allowed": "opponent_pts_per_game",
    "points allowed per game": "opponent_pts_per_game",
    "points allowed": "opponent_pts_per_game",
    "opponent ppg": "opponent_pts_per_game",
    "opponent points per game": "opponent_pts_per_game",
    "opponent points allowed per game": "opponent_pts_per_game",
    "opponent points allowed": "opponent_pts_per_game",
    "opponent points": "opponent_pts_per_game",
    "opp ppg": "opponent_pts_per_game",
