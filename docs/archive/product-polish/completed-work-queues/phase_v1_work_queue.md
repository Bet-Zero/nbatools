> **Archive status:** Completed product-polish work queue.
>
> **Current active product-polish plan:** See [../../../planning/product_polish_master_plan.md](../../../planning/product_polish_master_plan.md).
>
...
- Produce inventory at `docs/archive/product-polish/inventories/phase_v1_css_inventory.md`

**Files likely touched:**

- `docs/archive/product-polish/inventories/phase_v1_css_inventory.md` (new)
...
- `docs/archive/product-polish/completed-work-queues/phase_v1_work_queue.md` — check this item, add retrospective
