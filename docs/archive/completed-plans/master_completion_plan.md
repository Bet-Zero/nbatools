...
- [`source_approval_route_expansion_queue.md`](../completed-work-queues/source_approval_route_expansion_queue.md)
...
- [`source_backed_execution_queue.md`](../completed-work-queues/source_backed_execution_queue.md) is
...
- [`phase_k_work_queue.md`](../completed-work-queues/phase_k_work_queue.md) is the completed queue
...
- [`phase_l_work_queue.md`](../completed-work-queues/phase_l_work_queue.md) is the completed queue
  that reran the full parser-examples sweep, refreshed the blocker inventory,
  and drafted the Phase M continuation.
- [`phase_m_work_queue.md`](../completed-work-queues/phase_m_work_queue.md) is the completed closure
  ...
  master plan.
- [`clutch_source_boundary.md`](../handoffs-and-boundaries/clutch_source_boundary.md) records the
