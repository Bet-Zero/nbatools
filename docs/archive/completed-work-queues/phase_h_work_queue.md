...
- [`phase_f_execution_gap_inventory.md` §4](../inventories/phase_f_execution_gap_inventory.md#4-schedule-context-feature-join-contract)
- [`parser_execution_completion_plan.md` §5.3](../completed-plans/parser_execution_completion_plan.md#53-phase-h--schedule-context-execution)
...
- [`phase_f_execution_gap_inventory.md` §Schedule-context filters](../inventories/phase_f_execution_gap_inventory.md#3-schedule-context-filters)
- `src/nbatools/commands/team_record.py`
- `src/nbatools/commands/player_game_summary.py`
