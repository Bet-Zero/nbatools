...
> [`master_completion_plan.md`](../completed-plans/master_completion_plan.md) to either name the
...
> is superseded by [`master_completion_plan.md`](../completed-plans/master_completion_plan.md),
...
- [`clutch_source_boundary.md`](../handoffs-and-boundaries/clutch_source_boundary.md)
- [`docs/reference/data_contracts.md`](../reference/data_contracts.md)
- [`phase_f_execution_gap_inventory.md`](../inventories/phase_f_execution_gap_inventory.md)
...
[`master_completion_plan.md`](../completed-plans/master_completion_plan.md) to state that the
