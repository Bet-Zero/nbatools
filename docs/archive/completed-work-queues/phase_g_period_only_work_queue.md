...
> **Role:** Sequenced, PR-sized work items for the period-only continuation of Phase G in [`parser_execution_completion_plan.md`](../completed-plans/parser_execution_completion_plan.md) — _execution-backed quarter / half / overtime filters after the Phase G clutch-source review split the original shared segment scope._
>
...
- [`phase_g_segment_data_review_handoff.md`](../handoffs-and-boundaries/phase_g_segment_data_review_handoff.md)
- [`phase_f_execution_gap_inventory.md` §2](../inventories/phase_f_execution_gap_inventory.md#2-period-window-data-contract)
