...
> **Role:** Sequenced, PR-sized work items for Phase E of [`query_surface_expansion_plan.md`](../completed-plans/query_surface_expansion_plan.md) — _New capability families._
>
...
## 10. `[x]` Add stretch / rolling-window query intent and routing
...
- [`query_surface_expansion_plan.md`](../completed-plans/query_surface_expansion_plan.md)
...
- The remaining gaps are now owned by [`parser_execution_completion_plan.md`](../completed-plans/parser_execution_completion_plan.md) and begin with [`phase_f_work_queue.md`](./phase_f_work_queue.md).
