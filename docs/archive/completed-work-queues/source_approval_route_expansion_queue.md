...
| ------------------------ | ----------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Clutch                   | Source path approved before implementation: official `PlayByPlayV3` plus local score-state derivation.                              | Approved for future implementation via [`clutch_source_boundary.md`](../handoffs-and-boundaries/clutch_source_boundary.md). Do not approximate clutch from whole-game logs, period-only box scores, or season-level clutch dashboard aggregates.               |
| On/off                   | Source path approved before implementation: upstream `teamplayeronoffsummary` via `nba_api.stats.endpoints.TeamPlayerOnOffSummary`. | Approved for future implementation via [`phase_i_on_off_source_boundary.md`](../handoffs-and-boundaries/phase_i_on_off_source_boundary.md). Whole-game `without_player` remains out of scope as an on/off substitute.                                          |
| Lineups                  | Source path approved before implementation: upstream `leaguelineupviz` via `nba_api.stats.endpoints.LeagueLineupViz`.               | Approved for future implementation via [`phase_j_lineup_source_boundary.md`](../handoffs-and-boundaries/phase_j_lineup_source_boundary.md). Roster membership remains out of scope as a lineup-unit substitute.                                                |
...
- [`phase_g_segment_data_review_handoff.md`](../handoffs-and-boundaries/phase_g_segment_data_review_handoff.md)
- [`phase_f_execution_gap_inventory.md`](../inventories/phase_f_execution_gap_inventory.md)
- [`docs/reference/data_contracts.md`](../reference/data_contracts.md)
...
[`clutch_source_boundary.md`](../handoffs-and-boundaries/clutch_source_boundary.md). Whole-game logs,
...
[`phase_i_on_off_source_boundary.md`](../handoffs-and-boundaries/phase_i_on_off_source_boundary.md) and
...
[`phase_j_lineup_source_boundary.md`](../handoffs-and-boundaries/phase_j_lineup_source_boundary.md) and
[`docs/reference/data_contracts.md`](../reference/data_contracts.md). Current
...
[`master_completion_plan.md`](../completed-plans/master_completion_plan.md) to name that queue as
...
only by [`master_completion_plan.md`](../completed-plans/master_completion_plan.md).
