...
- Update [`parser_examples_blocker_inventory.md`](../inventories/parser_examples_blocker_inventory.md)
...
- If the blocker inventory is empty or all remaining items are explicitly
  ...
  [`master_completion_plan.md`](../completed-plans/master_completion_plan.md) to close the whole
  plan.
