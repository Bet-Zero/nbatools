...
> **Role:** Sequenced, PR-sized work items for Phase A of [`query_surface_expansion_plan.md`](../completed-plans/query_surface_expansion_plan.md) — _phrasing parity on shipped capabilities._
>
...
- Review the plan's Phase B scope ([`query_surface_expansion_plan.md §5.2`](../completed-plans/query_surface_expansion_plan.md)) against what Phase A actually accomplished. Note any scope adjustments needed
- If the plan needs changes, edit [`query_surface_expansion_plan.md`](../completed-plans/query_surface_expansion_plan.md) in the same session — don't let it drift silently
...
- [`query_surface_expansion_plan.md §5.2`](../completed-plans/query_surface_expansion_plan.md) — Phase B scope
...
- [`query_surface_expansion_plan.md §7.2`](../completed-plans/query_surface_expansion_plan.md) — guardrail: honest unsupported over silent wrong
