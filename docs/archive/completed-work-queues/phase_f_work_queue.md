...
> **Role:** Sequenced, PR-sized work items for Phase F of [`parser_execution_completion_plan.md`](../completed-plans/parser_execution_completion_plan.md) — _execution-gap audit and shared contracts._
>
...
- Inventory every parser-shipped but execution-partial capability family listed in [`parser_execution_completion_plan.md` §4](../completed-plans/parser_execution_completion_plan.md#4-current-open-capability-gaps)
...
- [`parser_execution_completion_plan.md` §4](../completed-plans/parser_execution_completion_plan.md#4-current-open-capability-gaps)
...
- [`parser_execution_completion_plan.md` §§5.2-5.3](../completed-plans/parser_execution_completion_plan.md#52-phase-g--execution-backed-context-filters)
