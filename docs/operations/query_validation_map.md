...
| --- | --- | ---: |
| Full Raw QA corpus | `qa/raw_query_answer_corpus.yaml` | 314 |
...
| `public_query_acceptance` | `qa/harness_slices/public_query_acceptance.yaml` | 127 |
...
| --- | --- | --- |
| Full Raw QA corpus run | `outputs/raw_query_answer_qa/20260608T041500Z_full_top_single_game_performances_007/` | Current 314-case corpus run. All 314 expectation cases passed. |
| `public_query_acceptance` slice run | `outputs/raw_query_answer_qa/20260608T040000Z_top_single_game_performances_007/` | Current 127-case `public_query_acceptance` slice run. All 127 expectation cases passed. |
...
| Current generated `product_review.md` | `outputs/raw_query_answer_qa/20260608T040000Z_top_single_game_performances_007/product_review.md` | Generated by the current 127-case `public_query_acceptance` slice run. A product-review artifact retains the scope of its generating run. |
