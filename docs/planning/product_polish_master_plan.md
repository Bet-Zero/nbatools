...
**Active continuation: Track A, Part 2, Phase C1.** Specifically,
...
| Component layouts  | Phase C1 active; generic data tables still primary for most queries | Opinionated layouts per query class with charts            | Track A Part 2    |
