...
> **Role:** Sequenced, PR-sized work items for Phase G of [`parser_execution_completion_plan.md`](./parser_execution_completion_plan.md) — _execution-backed context filters._
>
...
- [`phase_f_execution_gap_inventory.md` §Shared execution-plumbing contract](./phase_f_execution_gap_inventory.md#shared-prerequisites-for-context-and-schedule-filters)
...
- [`phase_f_execution_gap_inventory.md` §Segment-split data contract](./phase_f_execution_gap_inventory.md#2-segment-split-data-contract)
- [`parser_execution_completion_plan.md` §5.2](./parser_execution_completion_plan.md#52-phase-g--execution-backed-context-filters)
...
- [`phase_f_execution_gap_inventory.md` §Clutch](./phase_f_execution_gap_inventory.md#1-clutch)
- [`docs/architecture/parser/specification.md` §8](../architecture/parser/specification.md#8-context-filters)
