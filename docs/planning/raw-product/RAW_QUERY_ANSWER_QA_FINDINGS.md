...
- Run ID: `20260513T025137Z`
- Corpus size: 80 cases
- Output report path: `outputs/raw_query_answer_qa/20260513T025137Z/report.md`
- Summary counts:
  - Result statuses: `ok: 69`, `no_result: 5`, `error: 6`
  - Expectation cases: `pass: 80`
  - Expectation checks: `pass: 401`
  - Failed case IDs: `[]`
  - Manual review statuses: `unreviewed: 64`, `expected_unsupported: 7`, `needs_product_decision: 3`, `pass: 5`, `verified_outlier: 1`
