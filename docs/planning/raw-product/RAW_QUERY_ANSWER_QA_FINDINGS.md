...
- Run ID: `20260513T040809Z`
- Corpus size: 80 cases
- Output report path: `outputs/raw_query_answer_qa/20260513T040809Z/report.md`
- Summary counts:
  ...
  - Suspicious flags: `missing_backend_answer_text: 22`
...
- AQ-006 and AQ-008 were resolved in Wave 6; the remaining cross-cutting limitation is frontend answer extraction / backend answer text coverage.
