...
- Summary counts:
  ...
  - Manual review statuses: `unreviewed: 180`, `expected_unsupported: 26`,
    `pass: 33`, `routing_issue: 1`, `missing_filter: 1`,
  ...
  - Answer text policies: `frontend_hero_expected: 150`,
    ...
    `<unspecified>: 43`
  - Answer text statuses: `frontend_hero_expected: 148`,
...
Latest Wave 5 run after Fix Wave 8C1:
...
- team record/date variants from AQ-025 and AQ-027 are fixed as of Fix Wave
  ...
  coverage
- remaining record/stat context gaps: possessive `Jokic's record...` returns
  no-result despite the triple-double condition, and `Curry ... from three`
  preserves last-20 but drops the three-point stat context
