...
- Run ID: `20260513T072000Z_wave4a_full`
- Corpus size: 145 cases
- Output report path: `outputs/raw_query_answer_qa/20260513T072000Z_wave4a_full/report.md`
- Summary counts:
  - Result statuses: `ok: 126`, `no_result: 13`, `error: 6`
  - Expectation cases: `pass: 139`, `fail: 6`
  - Expectation checks: `pass: 705`, `fail: 15`
  - Failed case IDs: `anthony_edwards_last_10_summary_no_match`, `kd_ts_top_defenses_missing_filters`, `lakers_road_record_last_season`, `celtics_120_15_threes_count_missing_filter`, `jokic_30_points_10_assists_finder_misparsed`, `anthony_edwards_wins_losses_split_no_match`
  - Manual review statuses: `unreviewed: 126`, `expected_unsupported: 8`, `pass: 10`, `verified_outlier: 1`
...
| AQ-014 | P1 | Compound thresholds | `celtics_120_15_threes_count_missing_filter`, `jokic_30_points_10_assists_finder_misparsed` | missing_filter / stat_binding_issue | open_deferred | The Celtics count preserves `120+ points` and season range but drops `15+ threes`; the Jokic compact finder binds `30` to assists and returns no-match instead of preserving `30 points` plus `10 assists`. Explicitly deferred from Fix Wave 4A to the next compound-threshold representation/execution wave. | compound threshold parsing/execution |
...
- Fix Wave 4A resolved AQ-011 and AQ-013 scalar semantics. AQ-014 compound
  threshold cases remain open by design for a dedicated condition-list wave.
