...
- `planning/raw-product/RAW_PRODUCT_QA_RELEASE_READINESS_CHECKPOINT.md` — release-readiness checkpoint for backend raw QA, frontend-copy QA, visual QA, public UI readiness, deploy parity, and next options
