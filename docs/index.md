...
- `planning/raw-product/BARE_PLAYER_VS_PLAYER_QUERY_POLICY_PREFLIGHT.md` — documentation-only policy decision for bare player-vs-player queries such as `LeBron vs KD`, separating current silent comparison behavior from the V1 ambiguous/unsupported recommendation and future clarification flow
